            ...
            return (
              <Card key={c.id} className="border-base-300/50">
                ...
                <CardContent>
                  ...
                  <p className="mt-2 text-xs text-base-content/60">{t("explore.budget", { amount: c.budget.toLocaleString(), currency: c.currency })} &middot; {t("explore.milestones", { count: c.milestones.length })} &middot; {c.startDate} - {c.endDate}</p>
                  <div className="mt-3">
                    {alreadyIn ? (
